            ...
            <div id="forgot-inner">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextUserForGot" CssClass="login-inp" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextEmailForgot" CssClass="login-inp" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <asp:Button ID="ButtonForgotPassword" CssClass="submit-login" runat="server" Text="" />
                        </td>
                    </tr>
                </table>
            </div>
