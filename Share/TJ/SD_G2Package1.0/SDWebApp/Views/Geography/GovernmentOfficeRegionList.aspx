<%@ Page Language="C#" MasterPageFile="~/Shares/Site1.Master" AutoEventWireup="true"
    CodeBehind="GovernmentOfficeRegionList.aspx.cs" Inherits="SD.Web.Views.Geography.GovernmentOfficeRegionList"
    Title="Goverment Office Region List" %>
                ...
                <tr>
                    <td>
                        <div class="filter">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:CheckBox Style="text-align: right" ID="chkIncludeInactive" runat="server" Text="Include Inactive"
                                AutoPostBack="True" OnCheckedChanged="FilterChanged" /></div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Panel ID="pnlGridViewGovt" runat="server">
                            <div class="Gridview">
                                <asp:GridView ID="grdGovtOfficeRegion" runat="server" AutoGenerateColumns="False"
                                    CellPadding="4" ForeColor="#333333" GridLines="Both" Width="775px" AllowPaging="True"
                                    PageSize="10" AllowSorting="True" OnSorting="GrdGovtOfficeRegion_OnSorting">
                                    <RowStyle BackColor="#EFF3FB" />
                                    <Columns>
                                        <asp:TemplateField HeaderText="Government Office Region Name" SortExpression="Name">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbtnGovtOffRegName" runat="server" PostBackUrl='<%#"~/Views/Geography/GovernmentOfficeRegionDetails.aspx?gid="+Eval("ID")%>'
                                                    Text='<%#Eval("Name")%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField HeaderText="Description" DataField="Description" SortExpression="Description" />
                                        <asp:BoundField HeaderText="County" DataField="County" SortExpression="County" />
