<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditContact.ascx.cs"
    Inherits="SD.Web.Controls.Contact.EditContact" %>
    ...
    <table style="width: 80%;">
        <tr>
            ...
            <td width="30%">
                ...
                <asp:Button ID="btnManager" runat="server" Text="..." OnClick="btnManager_Click" />
            </td>
        </tr>
        <tr>
            <td>
...
<div id="ContactLookupRegion" runat="server" visible="false">
    <uc:ContactLookUp ID="ContactLookup" runat="server" OnButtonCloseClick="ClosePopup"
        OnButtonSelectClick="SelectValueContact" />
</div>
